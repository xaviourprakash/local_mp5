...
const VideoRecorder = (props) => {
  ...
  const onChangeHandler = (data) => {
    ...
    let updatedField = VideoRecorderService.updateVideoOnChangeHandler(
      details,
      fields
    );
  ...
  const onBlurHandler = (data) => {
    let updatedField = VideoRecorderService.updateTextboxOnBlurHandler(
      data,
      fields
    );
  ...
  const renderAccordion = () => {
    ...
    return (
      ...
      >
        ...
        {VideoRecorderService.getElementSetting(data)}
