...
import DateFieldService from "./DateField.Service";
...
const DateField = (props) => {
  ...
  const onChangeHandler = (data) => {
    let updatedField = DateFieldService.updateDateOnChangeHandler(data, fields);
  ...
  const renderAccordion = () => {
    ...
    return (
      <Accordion
        type={FBService.getTranslation("Label_Date_Input", FormBuilderResource)}
